...
void ShadingScene::setup_uniform_buffers(size_t num_buffers)
{
...
void ShadingScene::setup_uniform_descriptor_sets()
{
...
void ShadingScene::update_uniforms(size_t index)
{
    Uniforms ubo;
